...
export interface ISessionRepository<M> {
    save: <SV,C,AS> (session: Session<M,SV,C,AS>) => Promise<void>;
    get: <SV,C,AS> (selfUniqueId: UniqueId, counterPartyUniqueId: UniqueId) => Promise<Session<M,SV,C,AS>>;
